import { getPoolStats, insertQuestions } from './question-pool.js';
...
export const seedStaticPool = async () => {
  ...
  return { inserted: inserted.length, skipped: skipped.length, rejected: trueRejected.length, ready: stats.ready, total: stats.total };
};
